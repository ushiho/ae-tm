 ...
 */
final class Version20181229225946 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fuel_reconciliation ADD mission_id INT NOT NULL, ADD receipt_num VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fuel_reconciliation DROP mission_id, DROP receipt_num');
    }
}
