...
use App\Controller\PrintSideController;
...
class ExcelGeneratorController
{
    ...
    private function addPageHeader(Worksheet $sheet, PrintSide $prinSide,$number)
    {
        ...
        $sheet->setCellValue('I2',''.$project->getName())->mergeCells('I2:J2');
    ...
    {
        $sheet->fromArray(
            ['A6'=> 'DATE','B6'=> 'N°','C6'=> 'LICENCE PLATE', 'D6'=> 'DRIVER','E6'=>'DEPARTMENT',
            'F6'=>'KM','G6'=>'LITRES','H6'=>'AMOUNT', 'I6'=> 'VEHICLES','J6'=>'NOTE'
            ],
            null,
            'A6'
        );
